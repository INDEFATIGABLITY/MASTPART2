  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#FFFFFF', padding: 20 }}>
      ...
      <View style={styles.centerItems}>
        <Image source={require('./assets/burger.png')} style={{ width: 348, height: 123 }} />
        ...
        <Image source={require('./assets/ribs.png')} style={{ width: 348, height: 123, marginTop: 30 }} />
        <Text style={styles.dishName}>Ribs</Text>
        <TouchableOpacity style={styles.orderButton} onPress={() => navigation.navigate('Payment')}>
          <Text style={styles.buttonText}>Order</Text>
        </TouchableOpacity>
